 ...
 *
 */
public class SsMapper extends Mapper<LongWritable, Text, VisitKey, Text> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        VisitKey VisitKey = new VisitKey(symbol, timestamp);

        context.write(VisitKey, new Text(url));
        _log.debug(VisitKey.toString() + " => " + url);
    }
}
